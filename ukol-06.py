...
volba_uzivatele = input("Jakou značku vozidla si přejete vypůjčit (Peugeot nebo Škoda)?: ")
...
if volba_uzivatele == "Peugeot":
    ...
    print("Vybraná značka vozidla není k dispozici. Vyberte prosím Peugeot nebo Škoda.")
